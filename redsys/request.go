...
type Request struct {
	...
	OperationType      OperationType `xml:"DS_MERCHANT_TRANSACTIONTYPE" json:"DS_MERCHANT_TRANSACTIONTYPE,string"`
	MerchantCode       string        `xml:"DS_MERCHANT_MERCHANTCODE" json:"DS_MERCHANT_MERCHANTCODE"`
	Terminal           int           `xml:"DS_MERCHANT_TERMINAL" json:"DS_MERCHANT_TERMINAL,string"`
	...
	Currency           Currency      `xml:"DS_MERCHANT_CURRENCY,omitempty" json:"DS_MERCHANT_CURRENCY,string,omitempty"`
	Language           Language      `xml:"DS_MERCHANT_CONSUMERLANGUAGE,omitempty" json:"Ds_Merchant_ConsumerLanguage,string,omitempty"`
...
type Response struct {
	...
	Amount            int64         `xml:"OPERACION>Ds_Amount" json:"Ds_Amount,string"`
	Currency          Currency      `xml:"OPERACION>Ds_Currency" json:"Ds_Currency,string"`
	...
	Terminal          int           `xml:"OPERACION>Ds_Terminal" json:"Ds_Terminal,string"`
	...
	OperationType     OperationType `xml:"OPERACION>Ds_TransactionType" json:"Ds_TransactionType,string"`
